...
template_files=(
  ...
  "eww.scss : $HOME/.config/eww/eww.scss : scss"
  "waybar.css : $HOME/.config/waybar/style.css : css"
  "swaync.css : $HOME/.config/swaync/style.css : css"
  ...
  "kitty.conf : $HOME/.config/kitty/color.conf : generic"
  "wezterm_colors.lua : $HOME/.config/wezterm/colors.lua : generic"
)
